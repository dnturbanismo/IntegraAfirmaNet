    ...
    public class SignedXmlSignature
    {
        ...
        {            
            ...
            if ((value.LocalName == XmlSignatureConstants.ElementNames.Signature) && (value.NamespaceURI == XmlSignatureConstants.NamespaceURI))
            {
                ...
                XmlNodeList xnl = value.GetElementsByTagName(XmlSignatureConstants.ElementNames.SignedInfo, XmlSignatureConstants.NamespaceURI);
                ...
                xnl = value.GetElementsByTagName(XmlSignatureConstants.ElementNames.SignatureValue, XmlSignatureConstants.NamespaceURI);
                if ((xnl != null) && (xnl.Count == 1))
                {
                    signature = Convert.FromBase64String(xnl[0].InnerText);
                }

                xnl = value.GetElementsByTagName(XmlSignatureConstants.ElementNames.KeyInfo, XmlSignatureConstants.NamespaceURI);
                if ((xnl != null) && (xnl.Count == 1))
                {
                    key = new KeyInfo();
                ...
                xnl = value.GetElementsByTagName(XmlSignatureConstants.ElementNames.Object, XmlSignatureConstants.NamespaceURI);
